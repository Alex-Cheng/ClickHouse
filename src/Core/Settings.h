...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(UInt64, shuffle_join_optimization_buckets, 0, "The number of buckets for shuffle-based full_sorting_merge join optimization. 0 - disable.", 0 ) \
    M(UInt64, shuffle_join_optimization_max_key, 100000000, "The maximum value of the join key. The value is used to evenly divide bucket ranges for shuffle-based full_sorting_merge join optimization", 0 ) \
